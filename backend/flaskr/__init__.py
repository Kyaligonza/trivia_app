...
def create_app(test_config=None):
    ...
    def create_question():
        ...
        try:
            ...
            if search:
                ...
                # add the categories
                headings = Category.query.order_by(Category.id).all()
                categories_formatted = [item.format() for item in headings]
                categories = [item["type"] for item in categories_formatted]
  ...
  '''
    ...
    #           'success':False,
    #           'error': 500,
    #           'message':'sorry error on server side'
    #       }),500
